...
export const JasunFlags = Flags.register("Jasun", {
    LIFETIME_GYM_MEMBER: 0,
    UNKNOWN_FLAG_NUMBER_00179: 0,
    UNKNOWN_FLAG_NUMBER_00181: 0,
    UNKNOWN_FLAG_NUMBER_00180: 0,
});
...
function meetJasun(player: Character): NextScreenChoices {
    ...
    if (JasunFlags.UNKNOWN_FLAG_NUMBER_00179 === 0) {
        ...
        // IF FEMALE
            ...
            CView.text("\"<i>Look at that, it's like you were ready for me the whole time!</i>\" He motions with one of his clawed fingers at your attire. You shamelessly pose in a proud manner and it causes him to laugh heartily. He seems unperturbed or even turned on by the fact that your swimsuit barely covers anything at all, almost like he's totally used to seeing people wear this kind of thing. You wonder what world he could possibly be from to end up the way he is. \"<i>Come, come with me. I have something to show you.</i>\" He walks up to you and pushes by you with his humongous frame. As he does, he grabs your left wrist with his right arm and all but drags you from the changing room to show you whatever he's talking about.\n\n");
            // [Continue]
            return { next: meetJasun2 };
        }
    }
    // Met Jasun but not boned!
    else if (JasunFlags.UNKNOWN_FLAG_NUMBER_00179 > 0 && JasunFlags.UNKNOWN_FLAG_NUMBER_00180 === 0) {
        if (JasunFlags.UNKNOWN_FLAG_NUMBER_00181 === 0) {
            CView.text("While you look around the changing room, one of the gym's other patron asks you if you're looking for Jasun.  Seeing your confusion, they describe the hunky shark guy you met before.  You nod and smile, happy to have learned his name.\n\n");
            JasunFlags.UNKNOWN_FLAG_NUMBER_00181++;
        }
        // If you're a dude.
        if (player.gender <= 1) {
            CView.text("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
            CView.text("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
            CView.text("You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.");
            return { next: passTime(1) };
        }
        // IF YOU FAIL TO MEET ANY OF HIS CRITERIA NOW
        if (player.body.tone < 75 || player.inventory.armor.name !== ArmorName.SluttySwimwear) {
            CView.text("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it. As he turns to greet you, though, you notice that his smirk suddenly turns around to a sense of shock. He's noticed that you're not quite the same as you were before, and you know it. He pauses a moment before turning back toward the mirror and addressing you without eye contact.\n\n");

            CView.text("\"<i>" + player.desc.name + ", you know, I still don't think you're quite ready to swim with me. That's fine, and it's entirely up to you, but I think today I should probably swim alone. You can come and visit me anytime, of course, maybe when you're ");
            if (player.body.tone < 75) CView.text("fit enough");
            else if (player.inventory.armor.name !== ArmorName.SluttySwimwear) CView.text("properly attired");
            else CView.text("a little more compatible with me");
            CView.text(", we can go swim.</i>\" He hesitates for a moment at the mirror, and then walks past you quickly without making eye contact. Feeling dejected and suddenly very alone, you ignore the sensation caused by his skin brushing against yours and walk back to the gym's entrance. Maybe you can work yourself back into Jasun's graces with time.\n\n");
            // (-15 Lust, back to gym entrance)
            player.stats.lust += -15;

            return { next: passTime(1) };
        }
        CView.text("Jasun comes out of his stall and smiles when he sees you, already beginning to strain against the skimpy fabric of his bottom.  He asks, \"<i>Would you like to come swimming with me?</i>\" though his tone indicates that swimming may involve more than a few laps.");
        return { yes: meetJasun2, no: turnAwayFromAdj };
    }
    // Repeat
    else {
        // If you're a dude.
        if (player.gender <= 1) {
            CView.text("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it.  He glances your way and smirks.\n\n");
            CView.text("\"<i>Eyes to yourself, boy. Try to play any games and I'll tear you apart limb from limb. Now get out of here before I do it anyway.</i>\" The shark-morph snarls threateningly before turning to walk away.\n\n");
            CView.text("You doubt he'd have the nerve to murder someone here, but it's clear that so long as you lack a vagina Jasun will have no interest in you.  What a waste.");
            return { next: passTime(1) };
        }
        // IF YOU FAIL TO MEET ANY OF HIS CRITERIA NOW
        if (player.body.tone < 75 || player.inventory.armor.name !== ArmorName.SluttySwimwear) {
...
function meetJasun2(player: Character): NextScreenChoices {

    CView.sprite(SpriteName.Jasun); // 33;
    CView.text("You and he walk together for what can't be a very long time. He winds around the back side of the gym, avoiding the weightlifting room and going past the track altogether. You didn't even know that there were areas of the gym beyond what you had previously seen. He easily pushes aside a very thick door with one arm ");
    if (player.stats.str < 50) CView.text("that you're pretty sure you couldn't have moved on your own at all ");
    CView.text("and then suddenly stops. The light in the room blinds you for a moment, but then your eyes adjust and what you see makes you gasp. There's an entire swimming pool in here, and it's absolutely gargantuan! You pull away from the shark-man and walk up to the water, running your hand through it and looking about like a kid who just walked into a toy store. He walks up behind you slowly and sits down on the ledge into the pool beside you.\n\n");

    CView.text("\"<i>My name is Jasun, " + player.desc.name + ". My people love the water, but most of them are ferocious and have lost their way. Seeing as I could no longer stay with them without risking my own life constantly, I came to Tel'Adre and set about working with the gym here to set up this wondrous pool. I spend most of my time here. Not many people get to use it, but I think you are ready.</i>\" He smiles at you without baring his teeth and you're flattered, knowing how difficult that must be for something with his jaw structure. \"<i>Come, let's swim.</i>\" He puts out his hand, palm up, literally asking for your hand for him to take you into the water.\n\n");
    JasunFlags.UNKNOWN_FLAG_NUMBER_00181 = 1;
    // [Accept] [Turn Away]
    return { choices: [["Accept", acceptJasunsAdvances], ["Turn Away", turnAwayFromAdj]] };
}

// IF YOU TURN AWAY
function turnAwayFromAdj(player: Character): NextScreenChoices {

    CView.sprite(SpriteName.Jasun); // 33;
    CView.text("\"<i>I understand,</i>\" he says dejectedly. He steps up and walks back toward the door. He perks up at the last minute, not letting his being rejected hurt his pride in the least, and says, \"<i>If you ever would like to swim, you know where to find me. Farewell.</i>\" He stands at the door and waits for you to leave before leaping into the water alone, as he has done no doubt many times in the past.\n\n");

define(["require", "exports", "Engine/Items/Consumable", "../ConsumableName", "Engine/Utilities/SMath", "Engine/Body/Tail", "Engine/Body/Wings", "Content/Effects/EffectType", "Content/Utilities/NumToText", "Engine/Items/ItemDesc", "Content/Descriptors/BreastDescriptor", "./Reptilum", "Engine/Display/ContentView"], function (require, exports, Consumable_1, ConsumableName_1, SMath_1, Tail_1, Wings_1, EffectType_1, NumToText_1, ItemDesc_1, BreastDescriptor_1, Reptilum_1, ContentView_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ShriveledTentacle extends Consumable_1.Consumable {
        constructor() {
            super(ConsumableName_1.ConsumableName.ShriveledTentacle, new ItemDesc_1.ItemDesc("DryTent", "a shriveled tentacle", "A dried tentacle from one of the lake anemones.  It's probably edible, but the stingers are still a little active."));
        }
        use(character) {
            ContentView_1.CView.clear();
            ContentView_1.CView.text("You chew on the rubbery tentacle; its texture and taste are somewhat comparable to squid, but the half-dormant nematocysts cause your mouth to tingle sensitively.");
            let changes = 0;
            let changeLimit = 1;
            ...
            if (SMath_1.randInt(3) === 0 && character.stats.tou < 50 && changes < changeLimit) {
            ...
            // - speed down
            if (SMath_1.randInt(3) === 0 && character.stats.spe > 40 && changes < changeLimit) {
            ...
            if (SMath_1.randInt(3) === 0 && character.stats.cor < 20 && changes < changeLimit) {
            ...
            if (SMath_1.randInt(4) === 0 && changes < changeLimit && character.body.tails.reduce(Tail_1.Tail.HasType(Tail_1.TailType.BEE_ABDOMEN), false)) {
            ...
            if (SMath_1.randInt(4) === 0 && (character.body.wings.type === Wings_1.WingType.BEE_LIKE_SMALL || character.body.wings.type === Wings_1.WingType.BEE_LIKE_LARGE) && changes < changeLimit) {
            ...
            if (character.body.neck.gills && character.body.hair.type !== 4 && changes < changeLimit && SMath_1.randInt(5) === 0) {
                ...
                if (Reptilum_1.ReptilumFlags.HAIR_GROWTH_STOPPED_BECAUSE_LIZARD === 0) {
                    ContentView_1.CView.text("  <b>(Your hair has stopped growing.)</b>");
                    Reptilum_1.ReptilumFlags.HAIR_GROWTH_STOPPED_BECAUSE_LIZARD = 1;
                }
                changes++;
                changes++;
                changes++;
            ...
            if (SMath_1.randInt(5) === 0 && !character.body.neck.gills && character.body.skin.tone === "aphotic blue-black" && changes < changeLimit) {
                ContentView_1.CView.text("\n\nYou feel a pressure in your lower esophageal region and pull your garments down to check the area.  <b>Before your eyes a pair of feathery gills start to push out of the center of your chest, just below your neckline, parting sideways and draping over your " + BreastDescriptor_1.describeNipple(character, character.body.chest.firstRow) + "s.</b>  They feel a bit uncomfortable in the open air at first, but soon a thin film of mucus covers them and you hardly notice anything at all.  You redress carefully.");
                character.body.neck.gills = true;
                changes++;
            }
            // -[aphotic] skin tone (blue-black)
            if (SMath_1.randInt(5) === 0 && changes < changeLimit && character.body.skin.tone !== "aphotic blue-black") {
            ...
            if (character.body.hair.type === 4 && character.body.hair.length < 36 &&
                SMath_1.randInt(2) === 0 && changes < changeLimit) {
                const hairGrowth = 5 + SMath_1.randInt(3);
                character.body.hair.length += hairGrowth;
                ContentView_1.CView.text("\n\nAs you laboriously chew the rubbery dried anemone, your head begins to feel heavier.  Using your newfound control, you snake one of your own tentacles forward; holding it out where you can see it, the first thing you notice is that it appears quite a bit longer.  <b>Your head-tentacles are now " + NumToText_1.numToCardinalText(hairGrowth) + " inches longer!</b>");
                // (add one level of hairlength)
                changes++;
            }
        }
    }
    exports.ShriveledTentacle = ShriveledTentacle;
});
//# sourceMappingURL=ShriveledTentacle.js.map
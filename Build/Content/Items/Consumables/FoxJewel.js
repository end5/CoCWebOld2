define(["require", "exports", "Engine/Items/Consumable", "../ConsumableName", "Engine/Utilities/SMath", "Engine/Body/Ears", "Engine/Body/Skin", "Engine/Body/Tail", "Engine/Body/Vagina", "Content/Effects/EffectType", "Content/Utilities/NumToText", "Engine/Items/ItemDesc", "Content/Descriptors/SkinDescriptor", "Content/Descriptors/HairDescriptor", "Content/Descriptors/VaginaDescriptor", "Content/Descriptors/BreastDescriptor", "Engine/Display/ContentView", "Content/Modifiers/BodyModifier", "Content/Settings"], function (require, exports, Consumable_1, ConsumableName_1, SMath_1, Ears_1, Skin_1, Tail_1, Vagina_1, EffectType_1, NumToText_1, ItemDesc_1, SkinDescriptor_1, HairDescriptor_1, VaginaDescriptor_1, BreastDescriptor_1, ContentView_1, BodyModifier_1, Settings_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class FoxJewel extends Consumable_1.Consumable {
        constructor(mystic) {
            if (mystic)
                super(ConsumableName_1.ConsumableName.FoxJewelEnhanced, new ItemDesc_1.ItemDesc("MystJwl", "a mystic jewel", "The flames within this jewel glow brighter than before, and have taken on a sinister purple hue.  It has been enhanced to increase its potency, allowing it to transform you more easily, but may have odd side-effects..."), 20);
            else
                super(ConsumableName_1.ConsumableName.FoxJewel, new ItemDesc_1.ItemDesc("Fox Jewel", "a fox jewel", "A shining teardrop-shaped jewel.  An eerie blue flame dances beneath the surface."));
            this.mystic = mystic;
        }
        use(character) {
            ...
            if (character.stats.int < 100 && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(4) === 0))) {
            ...
            if (character.stats.str > 15 && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0))) {
            ...
            if (character.stats.tou > 20 && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0))) {
                // from 66 or less toughness
                if (character.stats.tou <= 66)
                    ContentView_1.CView.text("\n\nYou feel your " + SkinDescriptor_1.skinFurScales(character) + " becoming noticeably softer.  A gentle exploratory pinch on your arm confirms it - your " + SkinDescriptor_1.skinFurScales(character) + " won't offer you much protection.");
                // from 66 or greater toughness
                else
                    ContentView_1.CView.text("\n\nYou feel your " + SkinDescriptor_1.skinFurScales(character) + " becoming noticeably softer.  A gentle exploratory pinch on your arm confirms it - your hide isn't quite as tough as it used to be.");
                character.stats.tou += -1;
                if (character.stats.tou > 66)
                    character.stats.tou += -1;
                changes++;
            }
            if (this.mystic && changes < changeLimit && SMath_1.randInt(2) === 0 && character.stats.cor < 100) {
            ...
            if (((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(4) === 0)) && changes < changeLimit && character.body.femininity !== 50) {
                ContentView_1.CView.text(BodyModifier_1.displayModFem(character, 50, 2));
                changes++;
            }
            // [decrease muscle tone toward 40]
            if (character.body.tone >= 40 && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(4) === 0))) {
                ...
                character.body.tone -= 2 + SMath_1.randInt(3);
                changes++;
            }
            // [Adjust hips toward 10 � wide/curvy/flared]
            // from narrow to wide
            if (character.body.hips.rating < 10 && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0)) && changes < changeLimit) {
                character.body.hips.rating++;
                if (character.body.hips.rating < 7)
                    character.body.hips.rating++;
                if (character.body.hips.rating < 4)
                    character.body.hips.rating++;
            ...
            if (character.body.hips.rating > 10 && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0)) && changes < changeLimit) {
                character.body.hips.rating--;
                if (character.body.hips.rating > 14)
                    character.body.hips.rating--;
                if (character.body.hips.rating > 19)
                    character.body.hips.rating--;
                if (character.body.hips.rating > 24)
                    character.body.hips.rating--;
            ...
            if ((character.body.hair.length < 16 || character.body.hair.length > 26) && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0)) && changes < changeLimit) {
                // from short to long
                if (character.body.hair.length < 16) {
                    character.body.hair.length += 3 + SMath_1.randInt(3);
                    ContentView_1.CView.text("\n\nYou experience a tingling sensation in your scalp.  Feeling a bit off-balance, you discover your hair has lengthened, becoming " + HairDescriptor_1.describeHair(character) + ".");
                }
                // from long to short
                else {
                    character.body.hair.length -= 3 + SMath_1.randInt(3);
                    ContentView_1.CView.text("\n\nYou experience a tingling sensation in your scalp.  Feeling a bit off-balance, you discover your hair has shed a bit of its length, becoming " + HairDescriptor_1.describeHair(character) + ".");
                }
                changes++;
            }
            ...
            if (character.body.vaginas.length > 0 &&
                ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0)) &&
                bonusVCap && bonusVCap.values.vaginalCapacity && bonusVCap.values.vaginalCapacity < 200 &&
                changes < changeLimit) {
                ContentView_1.CView.text("\n\nA gurgling sound issues from your abdomen, and you double over as a trembling ripple passes through your womb.  The flesh of your stomach roils as your internal organs begin to shift, and when the sensation finally passes, you are instinctively aware that your " + VaginaDescriptor_1.describeVagina(character, character.body.vaginas.get(0)) + " is a bit deeper than it was before.");
            ...
            // [Vag of Holding] - rare effect, only if PC has high vaginal looseness
                ...
                if (Settings_1.Settings.sillyMode)
                    ContentView_1.CView.text("  <b>Your vagina has become a universe unto itself, capable of accepting colossal insertions beyond the scope of human comprehension!</b>");
                else
                    ContentView_1.CView.text("  <b>Your vagina is now capable of accepting even the most ludicrously sized insertions with no ill effects.</b>");
            ...
            // **********************
            // [Grow Fox Tail]
            if (!character.body.tails.reduce(Tail_1.Tail.HasType(Tail_1.TailType.FOX), false) && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(4) === 0))) {
                // if PC has no tail
            ...
            const foxTailCount = character.body.tails.filter(Tail_1.Tail.FilterType(Tail_1.TailType.FOX)).length;
            if (!this.mystic && character.body.ears.type === Ears_1.EarType.FOX && foxTailCount === 8 && SMath_1.randInt(3) === 0) {
            ...
            // (rare effect, up to max of 8 tails, requires PC level and int*10 = number of tail to be added)
                ...
                // else if PC has 2 or more fox tails
                    ...
                    ContentView_1.CView.text("\n\nA tingling pressure builds on your backside, and your bushy tails begin to glow with an eerie, ghostly light.  With a crackle of electrical energy, one of your tails splits in two, giving you " + NumToText_1.numToCardinalText(foxTailCount + 1) + "!  <b>You now have a cluster of " + NumToText_1.numToCardinalText(foxTailCount + 1) + " fox-tails.</b>");
                    // increment tail by 1
                }
                const newTail = new Tail_1.Tail();
                newTail.type = Tail_1.TailType.FOX;
            ...
            // [Grow 9th tail and gain Corrupted Nine-tails perk]
                ...
                character.effects.create(EffectType_1.EffectType.CorruptedNinetails);
            ...
            // [Grow Fox Ears]
            if (character.body.tails.reduce(Tail_1.Tail.HasType(Tail_1.TailType.FOX), false) && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(4) === 0)) && character.body.ears.type !== Ears_1.EarType.FOX && changes < changeLimit) {
            ...
            if (((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(4) === 0)) && changes < changeLimit && character.body.hair.color !== "golden blonde" && character.body.hair.color !== "silver blonde" && character.body.hair.color !== "white" && character.body.hair.color !== "black" && character.body.hair.color !== "red") {
            ...
            if (character.body.skin.type === Skin_1.SkinType.FUR || character.body.skin.type === Skin_1.SkinType.SCALES && ((this.mystic) || (!this.mystic && SMath_1.randInt(2) === 0))) {
                ContentView_1.CView.text("\n\nYou begin to tingle all over your " + SkinDescriptor_1.describeSkin(character) + ", starting as a cool, pleasant sensation but gradually worsening until you are furiously itching all over.");
                if (character.body.skin.type === Skin_1.SkinType.FUR)
                    ContentView_1.CView.text("  You stare in horror as you pull your fingers away holding a handful of " + character.body.hair.color + " fur!  Your fur sloughs off your body in thick clumps, falling away to reveal patches of bare, " + character.body.skin.tone + " skin.");
                else if (character.body.skin.type === Skin_1.SkinType.SCALES)
                    ContentView_1.CView.text("  You stare in horror as you pull your fingers away holding a handful of dried up scales!  Your scales continue to flake and peel off your skin in thick patches, revealing the tender " + character.body.skin.tone + " skin underneath.");
                ContentView_1.CView.text("  Your skin slowly turns raw and red under your severe scratching, the tingling sensations raising goosebumps across your whole body.  Over time, the itching fades, and your flushed skin resolves into a natural-looking ");
                ...
                if (!this.mystic && character.body.skin.tone !== "tan" && character.body.skin.tone !== "olive" && character.body.skin.tone !== "light") {
                    const skinTemp = SMath_1.randInt(3);
                    if (skinTemp === 0)
                    ...
                    const skinT = SMath_1.randInt(5);
                    if (skinT === 0)
                        character.body.skin.tone = "dark";
                    else if (skinT === 1)
                        character.body.skin.tone = "ebony";
                    else if (skinT === 2)
                        character.body.skin.tone = "ashen";
                    else if (skinT === 3)
                        character.body.skin.tone = "sable";
                    else
                        character.body.skin.tone = "milky white";
                }
                ContentView_1.CView.text(character.body.skin.tone + " complexion.");
                ContentView_1.CView.text("  <b>You now have " + SkinDescriptor_1.describeSkin(character) + "!</b>");
                changes++;
            }
            // Change skin tone if not changed you!
            else if (this.mystic && character.body.skin.tone !== "dark" && character.body.skin.tone !== "ebony" && character.body.skin.tone !== "ashen" && character.body.skin.tone !== "sable" && character.body.skin.tone !== "milky white" && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0))) {
                ...
                const mtoneTemp = SMath_1.randInt(5);
                if (mtoneTemp === 0)
                    character.body.skin.tone = "dark";
                else if (mtoneTemp === 1)
                    character.body.skin.tone = "ebony";
                    ...
                    character.body.skin.tone = "milky white";
                ContentView_1.CView.text(SkinDescriptor_1.describeSkin(character) + "!</b>");
                changes++;
            }
            // Change skin tone if not changed you!
            else if (!this.mystic && character.body.skin.tone !== "tan" && character.body.skin.tone !== "olive" && character.body.skin.tone !== "light" && changes < changeLimit && ((this.mystic && SMath_1.randInt(2) === 0) || (!this.mystic && SMath_1.randInt(3) === 0))) {
                ContentView_1.CView.text("\n\nYou feel a crawling sensation on the surface of your skin, starting at the small of your back and spreading to your extremities, ultimately reaching your face.  Holding an arm up to your face, you discover that <b>you now have ");
                const toneTemp = SMath_1.randInt(3);
                if (toneTemp === 0)
                    character.body.skin.tone = "tan";
                else if (toneTemp === 1)
                    character.body.skin.tone = "olive";
    ...
    exports.FoxJewel = FoxJewel;
});
//# sourceMappingURL=FoxJewel.js.map
define(["require", "exports", "Engine/Items/Consumable", "../ConsumableName", "Engine/Utilities/SMath", "Engine/Body/Cock", "Engine/Body/Skin", "Content/Effects/EffectType", "Engine/Items/ItemDesc", "Content/Descriptors/SkinDescriptor", "Content/Descriptors/CockDescriptor", "Content/Descriptors/HipDescriptor", "Content/Descriptors/LegDescriptor", "Engine/Display/ContentView", "Content/Modifiers/StatModifier"], function (require, exports, Consumable_1, ConsumableName_1, SMath_1, Cock_1, Skin_1, EffectType_1, ItemDesc_1, SkinDescriptor_1, CockDescriptor_1, HipDescriptor_1, LegDescriptor_1, ContentView_1, StatModifier_1) {
    "use strict";
    ...
    class Ectoplasm extends Consumable_1.Consumable {
        constructor() {
            super(ConsumableName_1.ConsumableName.Ectoplasm, new ItemDesc_1.ItemDesc("EctoPls", "a bottle of ectoplasm", "The green-tinted, hardly corporeal substance flows like a liquid inside its container. It makes you feel... uncomfortable, as you observe it."));
        }
        use(character) {
            ContentView_1.CView.clear();
            ContentView_1.CView.text("You grimace and uncork the bottle, doing your best to ignore the unearthly smell drifting up to your nostrils. Steeling yourself, you raise the container to your lips and chug the contents, shivering at the feel of the stuff sliding down your throat.  Its taste, at least, is unexpectedly pleasant.  Almost tastes like oranges.");
            let changes = 0;
            let changeLimit = 1;
            ...
            if (character.stats.int < 100 && SMath_1.randInt(3) === 0 && changes < changeLimit) {
            ...
            if (character.stats.sens >= 20 && SMath_1.randInt(3) === 0 && changes < changeLimit) {
                ContentView_1.CView.text("\n\nWoah, what the... you pinch your " + SkinDescriptor_1.describeSkin(character) + " to confirm your suspicions; the ghostly snack has definitely lowered your sensitivity.");
            ...
            if (character.stats.lib < 100 && SMath_1.randInt(3) === 0 && changes < changeLimit) {
                // ([if libido >49]
                ...
                ContentView_1.CView.text(" a trace amount of the ghost girl's lust is transferred into you.  How horny IS she, you have to wonder...");
            ...
            if (character.body.cocks.length > 0 && changes < changeLimit) {
                if (SMath_1.randInt(3) === 0 && character.body.cocks.get(0).type !== Cock_1.CockType.HUMAN) {
                    ContentView_1.CView.text("\n\nA strange tingling begins behind your " + CockDescriptor_1.describeCock(character, character.body.cocks.get(0)) + ", slowly crawling up across its entire length.  While neither particularly arousing nor uncomfortable, you do shift nervously as the feeling intensifies.  You resist the urge to undo your " + character.inventory.armor.displayName + " to check, but by the feel of it, your penis is shifting form.  Eventually the transformative sensation fades, <b>leaving you with a completely human penis.</b>");
                    character.body.cocks.get(0).type = Cock_1.CockType.HUMAN;
                    changes++;
                }
            }
            // Appearnace Change
            // Hair
            if (SMath_1.randInt(4) === 0 && changes < changeLimit && character.body.hair.type !== 2) {
            ...
            // Skin
            if (SMath_1.randInt(4) === 0 && changes < changeLimit && (character.body.skin.tone !== "sable" && character.body.skin.tone !== "white")) {
                if (SMath_1.randInt(2) === 0) {
            ...
            // Legs
            if (changes < changeLimit && !character.effects.has(EffectType_1.EffectType.Incorporeality) && (character.body.skin.tone === "white" || character.body.skin.tone === "sable") && character.body.hair.type === 2) {
                ...
                ContentView_1.CView.text("\n\nAn otherworldly sensation begins in your belly, working its way to your " + HipDescriptor_1.describeHips(character) + ". Before you can react, your " + LegDescriptor_1.describeLegs(character) + " begin to tingle, and you fall on your rump as a large shudder runs through them. As you watch, your lower body shimmers, becoming ethereal, wisps rising from the newly ghost-like " + LegDescriptor_1.describeLegs(character) + ". You manage to rise, surprised to find your new, ghostly form to be as sturdy as its former corporeal version. Suddenly, like a dam breaking, fleeting visions and images flow into your head, never lasting long enough for you to concentrate on one. You don't even realize it, but your arms fly up to your head, grasping your temples as you groan in pain. As fast as the mental bombardment came, it disappears, leaving you with a surprising sense of spiritual superiority.  <b>You have ghost legs!</b>\n\n");
                ContentView_1.CView.text("<b>(Gained Perk:  Incorporeality</b>)");
                character.effects.create(EffectType_1.EffectType.Incorporeality);
            }
            // Effect Script 8: 100% chance of healing
            if (changes === 0) {
                ContentView_1.CView.text("You feel strangely refreshed, as if you just gobbled down a bottle of sunshine.  A smile graces your lips as vitality fills you.  ");
                StatModifier_1.displayCharacterHPChange(character, character.stats.level * 5 + 10);
                changes++;
            }
    ...
    exports.Ectoplasm = Ectoplasm;
});
//# sourceMappingURL=Ectoplasm.js.map
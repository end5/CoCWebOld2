define(["require", "exports", "Engine/Character/Character", "Content/Character/CharacterType", "Engine/Body/Cock", "Engine/Character/CharacterDescription", "Engine/Combat/CombatContainer", "Engine/Items/Weapon", "Engine/Items/ItemDesc", "Engine/Items/Armor", "Engine/Combat/EndScenes", "Content/Combat/Actions/MainAction"], function (require, exports, Character_1, CharacterType_1, Cock_1, CharacterDescription_1, CombatContainer_1, Weapon_1, ItemDesc_1, Armor_1, EndScenes_1, MainAction_1) {
    "use strict";
    ...
    class ImpGang extends Character_1.Character {
        constructor() {
            super({
                type: CharacterType_1.CharacterType.ImpGang,
                unarmedWeapon: new Weapon_1.Weapon("", new ItemDesc_1.ItemDesc(""), "", "", 0),
                baseArmor: new Armor_1.Armor("", new ItemDesc_1.ItemDesc(""), "", 0)
            });

define(["require", "exports", "Engine/Flags", "Engine/Display/ScreenDisplay", "Engine/Display/ContentView", "Engine/Body/BreastRow", "Content/Menus/InGame/PlayerMenu", "Content/Scenes/PassTime", "Content/Descriptors/BreastDescriptor", "Content/Modifiers/ButtModifier", "Content/Descriptors/HairDescriptor", "Content/Utilities/NumToText", "Content/Modifiers/BreastModifier", "Engine/Body/Cock", "Content/Items/ConsumableName", "Engine/Utilities/SMath"], function (require, exports, Flags_1, ScreenDisplay_1, ContentView_1, BreastRow_1, PlayerMenu_1, PassTime_1, BreastDescriptor_1, ButtModifier_1, HairDescriptor_1, NumToText_1, BreastModifier_1, Cock_1, ConsumableName_1, SMath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.EssrayleFlags = Flags_1.Flags.register("Essrayle", {
        MET_ESSY: 0,
    ...
    function essrayleMeetingI(player) {
        ...
        if (exports.EssrayleFlags.MET_ESSY === 0) {
            ...
            if (player.stats.cor < 33)
                ContentView_1.CView.text("hastily looking away from her nude body");
            else if (player.stats.cor < 66)
                ContentView_1.CView.text("looking away out of courtesy");
            else
                ContentView_1.CView.text("letting your eyes roam over her as you search for even more depraved features on her nubile body");
            ContentView_1.CView.text(".");
            ...
            if (player.body.chest.sort(BreastRow_1.BreastRow.Largest).get(0).rating >= 10)
                ContentView_1.CView.text("own");
            else
                ContentView_1.CView.text("[chest]");
            ContentView_1.CView.text(".  \"<i>You must be one of those adventurers I've been hearing about, am I right?</i>\"");
        ...
        exports.EssrayleFlags.MET_ESSY++;
        // [Yes] [No]
        return {
            choices: [
                ["Yes", plantsForMe],
    ...
    exports.essrayleMeetingI = essrayleMeetingI;
    // >If No
    function noPlantsForMe(player) {
        ContentView_1.CView.clear();
        ContentView_1.CView.text("Essy pouts, ears flattening to the sides a bit.  \"<i>I see,</i>\" she nods, looking at you with thinly masked disappointment.  She seems to instantly put on a false smile and move aside, gesturing to the path ahead with a sweep of the arm.  \"<i>Well, in that case, you must be going somewhere important.  Best not keep you waiting.  I do wish you luck in your adventures!</i>\" She continues to beam as you head on off, leaving her behind you in no time.  Though as you leave, you swear you hear a mumbled, \"<i>Leave it to me to find the prudish ones.</i>\"");
        exports.EssrayleFlags.TURNED_DOWN_ESSY_FIRST_MEETING = 1;
        return { next: PassTime_1.passTime(1) };
    }
    // >If Yes
    function plantsForMe(player) {
        ContentView_1.CView.clear();
        if (exports.EssrayleFlags.ACCEPTED_ESSY_FIRST_MEETING === 0) {
            exports.EssrayleFlags.ACCEPTED_ESSY_FIRST_MEETING = 1;
            ContentView_1.CView.text("Essrayle giggles, sending ripples through her ample breasts.  \"<i>Oh, why thank you!  It's nothing major - I doubt it'll be much of a burden to you.  But in my travels, I've grown wilted and depleted of the energy to go on.  I'm soooo hungry!  Would you please-?</i>\"  She leaves the question hanging, looking to you imploringly.  Hastily your hand goes to where your supplies are housed, but you stop as she waves a hand dismissively.  \"<i>No, no, I don't mean biscuits or the like.</i>\"  Confused, you frown, but soften as you feel her hand rest upon your [chest].  \"<i>I require a special kind of food to do what I do, one that won't exhaust your supplies in the least.</i>\"\n\n");
        }
        // (If breasts
        if (player.body.chest.sort(BreastRow_1.BreastRow.Largest).get(0).rating > 1)
            ContentView_1.CView.text("Your nipples stiffen, breasts puffing out with a heated breath");
        else
            ContentView_1.CView.text("You arch your back gently, unconsciously pressing into her slender fingers a bit further");
        ContentView_1.CView.text(" as her hand begins to circle your chest.  \"<i>Though you, that's another story.</i>\"  She grins seductively as the air around you seems to thicken with a gentle pink mist.  Out of instinct, you look around, trying to discern the source - could she be one of the demons?");
        ...
        if (player.body.chest.get(0).rating >= 1) {
            ...
            if (player.body.chest.length > 1)
                ContentView_1.CView.text(" of your uppermost pair");
            ContentView_1.CView.text(".  You moan, and this only seems to encourage her, as she takes your nipples between thumb and forefinger, twisting and turning them this way and that.  She giggles at how your moans seem to fluctuate by coincidence, continuing to tease them");
            if (player.body.chest.length > 1)
                ContentView_1.CView.text(", steadily working over the multitude of fleshy mounds on your body");
            ContentView_1.CView.text(".");
            if (player.body.chest.find(BreastRow_1.BreastRow.FuckableNipples))
                ContentView_1.CView.text("  Her fingers play with your nipples and press gently to tease at them.  She seems quite surprised as they sink in with minimal effort.  A grin spreads over her face as she begins to steadily thrust those digits in and out of your nipples, fingers swirling about the interiors all the while.");
            ContentView_1.CView.text("  \"<i>You certainly have a lovely pair, but they could always be better, don't you think?</i>\"");
            // [Yes] [No]
            return {
                choices: [
                    ["Yes", ScreenDisplay_1.choiceWrap(plantsForMe2, 1)],
                    ["No", ScreenDisplay_1.choiceWrap(plantsForMe2, 2)],
                ]
            };
        }
        // Else
    ...
    function plantsForMe2(player, BE = 0) {
        ...
        if (player.body.cocks.length > 0 && player.body.vaginas.length > 0)
            ContentView_1.CView.text("find the dual sexes there.  Another hand joins the first, one gripping and tugging on your hardening cock as the other cups and squeezes over your pussy.");
        else if (player.body.cocks.length > 0) {
            ContentView_1.CView.text("circle about ");
            ...
            ContentView_1.CView.text(", beginning to squeeze and slide about its length until your nursing is interrupted by moans of your own delight");
        }
        else
            ContentView_1.CView.text("stroke about the puffy, now-inflamed lips of your own flower, taking the lips between two fingers and stroking up and down across their length fully before switching to your moist core.");
        ContentView_1.CView.text("\n\nA firm hand cups your ");
        if (player.body.legs.isTaur())
            ContentView_1.CView.text("back");
        else
            ContentView_1.CView.text("butt");
        ContentView_1.CView.text(" and pulls you close, forcing your [legs] against her bulb.  They sink in slightly as you go down, reluctantly relinquishing her nipple from your mouth.  As it springs free, a thick glob of sap splatters over your lips and nose.  Essy giggles softly as she wipes them off with a hand.");
        ...
        if (player.body.tails.length > 0)
            ContentView_1.CView.text("tail, ");
        ContentView_1.CView.text("and [legs], ");
        if (!player.body.legs.isTaur())
            ContentView_1.CView.text("lifting you slowly into the air");
        else
            ContentView_1.CView.text("forcing you to rear up");
        ContentView_1.CView.text(".  Her lower hands grasp you, helping to raise you up until you're at the proper height, whence she abruptly plants her lips upon your crotch.");
        // Cock=
        if (player.body.cocks.length > 0) {
            ...
            if (player.body.chest.get(0).rating >= 1)
                ContentView_1.CView.text(" and " + BreastDescriptor_1.breastCup(player.body.chest.get(0).rating) + " breasts");
            ContentView_1.CView.text(".  The opaque cups pump and suck, Essy humming to herself as the base of her tongue continues to skillfully tease over every hot spot near the [cockHead biggest] of your [cock biggest], her length slithering about it skillfully.");
        }
        // (Pussy=
        else {
        ...
        if (player.body.chest.sort(BreastRow_1.BreastRow.Largest).get(0).rating >= 1) {
            ...
            if (player.lactationQ() >= 400)
                ContentView_1.CView.text("your milk and ");
            ContentView_1.CView.text("your pleasure.  In time, their pumping increases in force and tempo just as her lips and tongue do.");
        }
        ...
        ButtModifier_1.displayStretchButt(player, 10, true, true, false);
        ...
        if (BE === 1) {
            ...
            if (player.body.chest.reduce(BreastRow_1.BreastRow.TotalNipples, 0) > 2)
                ContentView_1.CView.text("s have");
            else
                ContentView_1.CView.text(" has");
            ContentView_1.CView.text(" been swallowed up as well.");
            ...
            if (player.body.chest.length > 1)
                ContentView_1.CView.text("  She eventually dislodges with a wet pop, setting your new breasts to wobbling about as she moves down your body, repeating the gestures upon each set of breasts in return.");
            ContentView_1.CView.text("\n\nWeak from the pleasure, the last thing you see is her smiling face before you fall forward into her embrace.  The next thing you know, you're alone in the glade, staring at the canopy above.  There's a heavy weight on your chest and you struggle to sit up.  " + NumToText_1.numToCardinalCapText(player.body.chest.length * 2) + " massive breasts jiggle and sway upon your chest, all full and aching to be milked");
            if (player.body.chest.length > 1)
                ContentView_1.CView.text(", the top pair being largest, descending in size with each subsequent pair");
            ContentView_1.CView.text(".");
            // Boost size, set lactation quantity.
            BreastModifier_1.growTopBreastRowDownwards(player, 7, player.body.chest.length);
            BreastModifier_1.boostLactation(player, player.body.chest.length);
        ...
        if (player.body.chest.length > 0 && player.isLactating()) {
            player.milked();
            BreastModifier_1.boostLactation(player, 0.01);
        }
        player.orgasm();
        player.stats.lib += 1;
        // Slimefeed!
    ...
    function feedTrappedEssy(player) {
        ...
        exports.EssrayleFlags.ESSY_DUNGEON_FUCKED++;
        if (player.gender === 1)
            return hasCockFeedEssy(player, false);
        if (player.gender === 2)
            return hasPussyFeedEssy(player, false);
        if (player.gender === 3) {
            ContentView_1.CView.text("  How best to make use of this floral beauty?");
            return {
                choices: [
                    ["Cock", ScreenDisplay_1.choiceWrap(hasCockFeedEssy, true)],
                    ["Pussy", ScreenDisplay_1.choiceWrap(hasPussyFeedEssy, true)],
                ]
            };
        }
    ...
    function hasCockFeedEssy(player, newPage = true) {
        ...
        if (player.body.cocks.sort(Cock_1.Cock.Largest).get(0).length < 20)
            ContentView_1.CView.text("her lower pair of wobbling udders");
        else
            ContentView_1.CView.text("both sets of milk-bloated breasts");
        ContentView_1.CView.text(" faster and faster, the hot slapping of her bountiful bosom against your [cock]");
        if (player.body.balls.count > 0)
            ContentView_1.CView.text(" and your swollen, heavy balls against her fecund belly");
        ContentView_1.CView.text(" setting an inspiring drum beat to your feverish pace.");
    ...
    function hasPussyFeedEssy(player, newPage = true) {
        if (newPage)
            ContentView_1.CView.clear();
        else
            ContentView_1.CView.text("\n\n");
        ContentView_1.CView.text("Repositioning one of Essy's massive tits, you opt to try something new, something different.  Essy's long, fat nipples glisten with plump promise as you climb up, over the lip of her ensorcelled flowerpot.  The soil is soft and moist with her milk as you gently push her back, leaning the girl's pliant form against the bulging swell of her pronounced ass.  She reclines, woozy and unable to process what it is that you're doing as you move over her ponderous bosom.  It takes almost no effort to guide one of the pert, fist-thick nipples into your womanly folds, sliding it into your [vagina] with ");
        if (player.body.vaginas.get(0).looseness < 2)
            ContentView_1.CView.text("a gasping grunt of effort");
        else if (player.body.vaginas.get(0).looseness < 4)
            ContentView_1.CView.text("little resistance");
        else
            ContentView_1.CView.text("virtually no resistance at all");
        ContentView_1.CView.text(".  With some effort, you take the plant girl's peak to its leaf-green hilt, the soft skin of her pliant breast squeezed against your [hips], teat-like nipple a pulsing cock-like shaft inside your [vagina].");
    ...
    function essyWitchVictory(player) {
        ...
        exports.EssrayleFlags.ESSRAYLE_ESCAPED_DUNGEON = 1;
        return {
            choices: [
    ...
    exports.essyWitchVictory = essyWitchVictory;
    // [No]
    function declineEssyPrizes(player) {
        ContentView_1.CView.clear();
        ContentView_1.CView.text("Essy sighs and shakes her head.  \"<i>What a let down!</i>\"  She shrugs, throwing all four arms into the air helplessly, and digs about in the pouch she keeps on her vine belt.  \"<i>Here, hope this tickles your fancy.</i>\"  She reaches out and places a number of glittering gems into your hand.  \"<i>They don't do me much good anyway.</i>\"");
        // (Player gains some more gems)
        player.inventory.gems += 100 + SMath_1.randInt(70);
    ...
    function acceptEssyPrizes(player) {
        ...
        if (player.body.chest.sort(BreastRow_1.BreastRow.Largest).get(0).rating <= 1) {
            ContentView_1.CView.text("four bulging tits erupt from your chest");
        ...
        // if two breasts:
            ...
            ContentView_1.CView.text("two more bulging tits erupt from your chest");
            if (player.body.chest.get(0).rating < 4) {
                ContentView_1.CView.text(" while your top row expands");
                player.body.chest.get(0).rating = 4;
            }
            if (player.body.chest.length === 1)
                player.body.chest.add(new BreastRow_1.BreastRow());
        ...
        // if four+ breasts:
            ...
            ContentView_1.CView.text("your [fullChest] swell larger and larger under the expanding magic of the spell");
            BreastModifier_1.growTopBreastRowDownwards(player, 6, player.body.chest.length);
        }
        BreastModifier_1.boostLactation(player, player.body.chest.length);
        ContentView_1.CView.text(", filling with warm, fluid weight.  They jiggle and wobble against each other and your belly as they adjust to their brimming plumpness.  You now proudly sport [fullChest].");
    ...
    // [Yes]
    function yesGimmeGiantNipplesEssy(player) {
        ContentView_1.CView.clear();
        ContentView_1.CView.text("She smiles knowingly and, reaching into her pouch once more, Essy produces a strange looking fruit.  It seems almost like a plum-colored eggplant, but it feels soft and rubbery to the touch.  \"<i>Here ya go!  Whenever you'd like, enjoy this!</i>\"  She places the strange thing in your hands.  \"<i>Call it my gift to another chest connoisseur.</i>\"");
        essyRewardEpilogueOUTTIES(player);
        // [gain purple fruit] [Next]
        return player.inventory.items.createAdd(player, ConsumableName_1.ConsumableName.PurpleFruit, PassTime_1.passTime(1));
    }
    // [No]
    function noGimmeGiantNipplesEssy(player) {
        ContentView_1.CView.clear();
        ContentView_1.CView.text("She shrugs her shoulders, giving one bundle of milk-drooling nipples a soft squeeze.  \"<i>Eh, to each their own, I suppose.</i>\"");
        return essyRewardEpilogueOUTTIES(player);
    }
    // [Either choice]
    function essyRewardEpilogueOUTTIES(player) {
    ...
    function askMotherToReleaseEssy(player) {
        ContentView_1.CView.clear();
        if (exports.EssrayleFlags.SAND_WITCHES_COWED === 0) {
            ContentView_1.CView.text("You point out that the witches have a friend of yours trapped here with magic and you'd like her released.");
            ...
            ContentView_1.CView.text("You command the Sand Mother to release your friend, Essrayle from her magical bondage.  The sorcerous queen looks about to protest, but after a brief pause, she admits, \"<i>Fine, I'll see her released.  You can go pick her up.</i>\"  She practically spits the last sentence.");
            ContentView_1.CView.text("\n\nThat'll do.");
        }
        exports.EssrayleFlags.TOLD_MOTHER_TO_RELEASE_ESSY = 1;
        return { next: PlayerMenu_1.playerMenu };
    }
    exports.askMotherToReleaseEssy = askMotherToReleaseEssy;
});

define(["require", "exports", "Content/Effects/EffectType", "Engine/Utilities/SMath"], function (require, exports, EffectType_1, SMath_1) {
    "use strict";
     ...
     */
    function combatDodge(char, dodgingChar) {
    ...
    exports.combatDodge = combatDodge;
    function combatMiss(character, monster) {
        return character.stats.spe - monster.stats.spe > 0 && SMath_1.randInt(((character.stats.spe - monster.stats.spe) / 4) + 80) > 80;
    }
    exports.combatMiss = combatMiss;
    function combatEvade(character, monster) {
        return monster.desc.short !== "Kiha" && character.effects.has(EffectType_1.EffectType.Evade) && SMath_1.randInt(100) < 10;
    }
    exports.combatEvade = combatEvade;
    function combatFlexibility(character, monster) {
        return character.effects.has(EffectType_1.EffectType.Flexibility) && SMath_1.randInt(100) < 6;
    }
    exports.combatFlexibility = combatFlexibility;
    function combatMisdirect(character, monster) {
        return character.effects.has(EffectType_1.EffectType.Misdirection) && SMath_1.randInt(100) < 10 && character.inventory.armor.displayName === "red, high-society bodysuit";
    }
    exports.combatMisdirect = combatMisdirect;
    function combatRegeneration(character) {
        let healingPercent = 0;
        if (character.effects.has(EffectType_1.EffectType.Regeneration))
            healingPercent += 1;
        if (character.effects.has(EffectType_1.EffectType.Regeneration2))
            healingPercent += 2;
    ...
    exports.combatRegeneration = combatRegeneration;
    function fatigueRecovery(character) {
        character.stats.fatigue--;
        if (character.effects.has(EffectType_1.EffectType.EnlightenedNinetails) || character.effects.has(EffectType_1.EffectType.CorruptedNinetails))
            character.stats.fatigue -= (1 + SMath_1.randInt(3));
    }
    exports.fatigueRecovery = fatigueRecovery;
});
...
//     }
// }
//# sourceMappingURL=CombatUtils.js.map
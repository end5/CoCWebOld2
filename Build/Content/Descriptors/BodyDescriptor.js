define(["require", "exports", "Engine/Body/BreastRow", "Content/Body/RaceScore", "Engine/Body/GenderIdentity", "./GenderDescriptor", "./VaginaDescriptor", "./ButtDescriptor"], function (require, exports, BreastRow_1, RaceScore, GenderIdentity_1, GenderDescriptor_1, VaginaDescriptor_1, ButtDescriptor_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function describeBody(character) {
        let description = "";
        // OLD STUFF
        // SUPAH THIN
        ...
        // average
            ...
            if (character.body.tone > 90)
                ...
                if (character.gender >= 2 || character.body.chest.sort(BreastRow_1.BreastRow.Largest).get(0).rating > 3 || character.body.hips.rating > 7 || character.body.butt.rating > 7)
        ...
        // Chunky monkey
            ...
            if (character.body.tone > 90)
                ...
                if (character.gender >= 2 || character.body.chest.sort(BreastRow_1.BreastRow.Largest).get(0).rating > 4 || character.body.hips.rating > 10 || character.body.butt.rating > 10)
    ...
    exports.describeBody = describeBody;
    function describeRace(character) {
        let race = "human";
        ...
        if (RaceScore.catRaceScore(character) >= 4)
            race = "cat-" + GenderDescriptor_1.mf(character, "boy", "girl");
        ...
        if (RaceScore.dragonRaceScore(character) >= 4) {
            ...
            if (character.body.face.type === 0)
                race = "dragon-" + GenderDescriptor_1.mf(character, "man", "girl");
        }
        ...
        if (RaceScore.dogRaceScore(character) >= 4) {
            race = "dog-morph";
            if (character.body.face.type === 0)
                race = "dog-" + GenderDescriptor_1.mf(character, "man", "girl");
        }
        if (RaceScore.foxRaceScore(character) >= 4) {
            if (character.body.skin.type === 1)
                race = "fox-morph";
            else
                race = "fox-" + GenderDescriptor_1.mf(character, "morph", "girl");
        }
        if (RaceScore.ferretRaceScore(character) >= 4) {
            if (character.body.skin.type === 1)
                race = "ferret-morph";
            else
                race = "ferret-" + GenderDescriptor_1.mf(character, "morph", "girl");
        }
        ...
        if (RaceScore.cowRaceScore(character) > 5) {
            race = "cow-";
            race += GenderDescriptor_1.mf(character, "morph", "girl");
        }
        ...
        if (RaceScore.bunnyRaceScore(character) >= 4)
            race = "bunny-" + GenderDescriptor_1.mf(character, "boy", "girl");
        ...
        if (RaceScore.spiderRaceScore(character) >= 4) {
            race = "spider-morph";
            if (GenderDescriptor_1.mf(character, "no", "yes") === "yes")
                race = "spider-girl";
        ...
        if (RaceScore.mouseRaceScore(character) >= 3) {
            if (character.body.face.type !== 16)
                race = "mouse-" + GenderDescriptor_1.mf(character, "boy", "girl");
            else
                race = "mouse-morph";
        }
        ...
        if (RaceScore.gooRaceScore(character) >= 3) {
            race = "goo-";
            race += GenderDescriptor_1.mf(character, "boi", "girl");
        }
        return race;
    }
    exports.describeRace = describeRace;
    function assholeOrPussy(character) {
        if (character.body.vaginas.length > 0)
            return VaginaDescriptor_1.describeVagina(character, character.body.vaginas.get(0));
        return ButtDescriptor_1.describeButthole(character.body.butt);
    }
    exports.assholeOrPussy = assholeOrPussy;
});
//# sourceMappingURL=BodyDescriptor.js.map